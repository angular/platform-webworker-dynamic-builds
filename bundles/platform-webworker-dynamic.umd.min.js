...
/**
     ...
     */var i=new a.Version("10.0.0-rc.0+108.sha-f6ee911"),l=a.createPlatformFactory(n.ɵplatformCoreDynamic,"workerAppDynamic",[{provide:a.COMPILER_OPTIONS,useValue:{providers:[{provide:o.ResourceLoader,useClass:n.ɵResourceLoaderImpl,deps:[]}]},multi:!0},{provide:a.PLATFORM_ID,useValue:r.ɵPLATFORM_WORKER_UI_ID}]);
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
