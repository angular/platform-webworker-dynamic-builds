...
/**
     ...
     */var i=new a.Version("9.0.0-rc.1+898.sha-3d4067a"),l={providers:[{provide:o.ResourceLoader,useClass:n.ɵResourceLoaderImpl,deps:[]}]},m=r.ɵPLATFORM_WORKER_UI_ID,u=a.createPlatformFactory(n.ɵplatformCoreDynamic,"workerAppDynamic",[{provide:a.COMPILER_OPTIONS,useValue:l,multi:!0},{provide:a.PLATFORM_ID,useValue:m}]);
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
