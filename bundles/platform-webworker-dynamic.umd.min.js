...
/**
     ...
     */var i=new r.Version("6.1.0-rc.3+74.sha-968f153"),m=r.createPlatformFactory(n.ɵplatformCoreDynamic,"workerAppDynamic",[{provide:r.COMPILER_OPTIONS,useValue:{providers:[{provide:a.ResourceLoader,useClass:n.ɵResourceLoaderImpl,deps:[]}]},multi:!0},{provide:r.PLATFORM_ID,useValue:o.ɵPLATFORM_WORKER_UI_ID}]);
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
