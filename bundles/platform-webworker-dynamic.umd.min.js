...
/**
     ...
     */var i=new a.Version("7.2.4+31.sha-1b6fb5b"),l=a.createPlatformFactory(n.ɵplatformCoreDynamic,"workerAppDynamic",[{provide:a.COMPILER_OPTIONS,useValue:{providers:[{provide:o.ResourceLoader,useClass:n.ɵResourceLoaderImpl,deps:[]}]},multi:!0},{provide:a.PLATFORM_ID,useValue:r.ɵPLATFORM_WORKER_UI_ID}]);
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
