...
/**
     ...
     */var i=new r.Version("7.1.0-beta.0+57.sha-1130e48"),m=r.createPlatformFactory(n.ɵplatformCoreDynamic,"workerAppDynamic",[{provide:r.COMPILER_OPTIONS,useValue:{providers:[{provide:a.ResourceLoader,useClass:n.ɵResourceLoaderImpl,deps:[]}]},multi:!0},{provide:r.PLATFORM_ID,useValue:o.ɵPLATFORM_WORKER_UI_ID}]);
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
