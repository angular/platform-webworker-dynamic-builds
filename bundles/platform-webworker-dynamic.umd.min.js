...
/**
     ...
     */var i=new a.Version("9.1.0-next.2+74.sha-de67978"),l={providers:[{provide:o.ResourceLoader,useClass:n.ɵResourceLoaderImpl,deps:[]}]},m=r.ɵPLATFORM_WORKER_UI_ID,u=a.createPlatformFactory(n.ɵplatformCoreDynamic,"workerAppDynamic",[{provide:a.COMPILER_OPTIONS,useValue:l,multi:!0},{provide:a.PLATFORM_ID,useValue:m}]);
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
