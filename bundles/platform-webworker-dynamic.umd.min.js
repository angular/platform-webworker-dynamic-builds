...
/**
     ...
     */var i=new a.Version("8.1.0-next.2+5.sha-bb4e230.with-local-changes"),l={providers:[{provide:o.ResourceLoader,useClass:n.ɵResourceLoaderImpl,deps:[]}]},m=r.ɵPLATFORM_WORKER_UI_ID,u=a.createPlatformFactory(n.ɵplatformCoreDynamic,"workerAppDynamic",[{provide:a.COMPILER_OPTIONS,useValue:l,multi:!0},{provide:a.PLATFORM_ID,useValue:m}]);
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
